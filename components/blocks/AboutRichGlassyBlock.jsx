// components/blocks/AboutRichGlassyBlock.jsx
"use client";
import React from "react";
import Image from "next/image";
import { motion } from "framer-motion";
import { normalizeMedia } from "@/components/utils/media";
import RichTextRenderer from "@/components/common/RichTextRenderer"; // ← import
...
export default function AboutRichGlassyBlock({ title, content, image }) {
  ...
  return (
    <section id="about-rich" className="relative mx-auto w-[92%] max-w-7xl py-16" dir="rtl">
