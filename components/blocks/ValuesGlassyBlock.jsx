  ...
  return (
    <section id="about-values" className="relative mx-auto w-[92%] max-w-7xl py-16" dir="ltr">
      ...
      <div className="grid items-center gap-8 lg:grid-cols-2">
        ...
        {img?.url && (
          ...
          >
            <div className="relative mx-auto aspect-[4/3] w-full max-w-xl">
              <Image
                src={img.url}
                alt={img.alt || section_title || "about"}
                fill
        ...
        >
          {section_subtitle && (
            <p className="mb-2 text-xs font-semibold uppercase tracking-[.25em] text-white/60">
              {section_subtitle}
            </p>
          )}
          {section_title && (
                ...
                >
                  <div className="mb-2 inline-flex items-center gap-2 rounded-xl border border-white/10 bg-white/8 px-2 py-1 text-white/90">
                    <span
                      ...
                      style={{ background: brand.sky, color: brand.navy }}
                    >
                  ...
                  {/* desc يدعم Blocks أو نص عادي */}
                  {Array.isArray(it.desc) ? (
                    <RichTextRenderer blocks={it.desc} />
                  ) : it.desc ? (
