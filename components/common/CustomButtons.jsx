...
export function SkyToGlassButton({ children, className = "", ...props }) {
  return (
    <Button
      {...props}
      className={`group relative overflow-hidden rounded-xl px-6 py-2 font-semibold text-sm border border-white/10 transition ${className}`}
...
export function GlassToSkyButton({ children, className = "", ...props }) {
  return (
    <Button
      {...props}
      className={`group relative overflow-hidden rounded-xl px-6 py-2 font-semibold text-sm border border-white/10 bg-white/10 text-white transition ${className}`}
      style={{
